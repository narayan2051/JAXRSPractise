...
public class Employee implements Serializable {
    ...
    public Employee(Integer id, String firstName, String lastName, String email, String contactNo, Date addedDate, boolean status) {
        this.id = id;
    ...
    public String toString() {
        return "com.leapfrog.jre.entity.Employee[ id=" + id + " ]";
    }
